...
<head>
	...
	<meta name="twitter:description" content="Nāc, redzi un piedzīvo to savā dzīvē. Dievs dara savu pārveidojošo darbu.">
        		...
        		<ul class="list-unstyled menu-elements">
            		<li>
                		<div class="col-auto ms-auto me-1">
							<h4 class="mb-2 mt-2 banner">
								<a class="scroll-link" href="#" onclick="show_section_bible()" style="{color:black} :hover {color: white}">
            		...
            		<li>
                		<div class="col-auto ms-1 me-1">
							<h4 class="mb-2 mt-2 banner">
								<a class="scroll-link" href="#" onclick="show_section_comments()" style="{color:black} :hover {color: white}">
            		...
            		<li>
                		<div class="col-auto ms-1 me-1">
							<h4 class="mb-2 mt-2 banner">
								<a class="scroll-link" href="#" onclick="show_section_dictionary()" style="{color:black} :hover {color: white}">
					...
					<li class="a_option a_option_hidden">
						<div class="col-auto ms-1 me-1">
							<h4 class="mb-2 mt-2 banner">
								<a href="#" onclick="show_section_comments_editor()" style="{color:black} :hover {color: white}">+</a>
							</h4>
						</div>
					</li>
        		</ul>
        ...
        <div class="row no-gutters align-items-center">
            ...
            <div class="col-auto mt-3 d-inline-block d-sm-none">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li class="mb-2"><a class="dropdown-item" style="justify-content: left; font-size: 16px" href="#" onclick="show_section_bible()"><i class="me-2 fas fa-book-bible"></i>Bībele</a></li>
                    <li class="my-2"><a class="dropdown-item" style="justify-content: left; font-size: 16px" href="#" onclick="show_section_comments()"><i class="me-2 fas fa-comment"></i>Komentāri</a></li>
                    <li class="my-2"><a class="dropdown-item" style="justify-content: left; font-size: 16px" href="#" onclick="show_section_dictionary()"><i class="me-2 fas fa-book"></i>Vārdnīca</a></li>
					<li><hr class="dropdown-divider"></li>
                	<li class="dropdown-submenu my-2">
            			<a class="dropdown-item" style="justify-content: left; font-size: 16px" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        			...
        			<li class="dropdown-submenu my-2">
            			...
            			<ul class="dropdown-menu">
                			<li class="dropdown-submenu" style="font-size: 15px; font-size: 15px">
                    			<a class="dropdown-item" href="#">Bībeles tulkojums <span style="margin-left: auto; white-space: nowrap;">&nbsp > </span></a>
                    			<ul class="dropdown-menu submenu" style="left: 100%">
                        			<li><a class="dropdown-item" onclick="set_tr('lv65')">LV1965 Rev</a></li>
                			...
                			<li class="dropdown-submenu" style="font-size: 15px">
                    			<a class="dropdown-item" href="#">Mainīt motīvu<span style="margin-left: auto; white-space: nowrap;"> > </span></a>
                			...
                			<li class="dropdown-submenu" style="font-size: 15px">
                    			<a class="dropdown-item" href="#">Burtu lielums<span style="margin-left: auto; white-space: nowrap;"> &nbsp> </span></a>
                    			<ul class="dropdown-menu submenu" style="left: 100%; font-size: 15px">
                        			<li><a class="dropdown-item" onclick="changeFontSize('small')">Mazs</a></li>
                        			<li><a class="dropdown-item" onclick="changeFontSize('medium')">Vidējs</a></li>
                        			<li><a class="dropdown-item" onclick="changeFontSize('large')">Liels</a></li>
                    			</ul>
                			</li>
                		</ul>
					</li>
    ...
    <div class="col-auto ms-auto">
        <div class="row no-gutters align-items-center">
            <div class="col-auto neradit-mob hide-buttons dropdown">
                <h4 class="banner" style="margin-bottom: 0; margin-top: 10px">
                    <a class="hide-element me-2" style="text-decoration: none" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <a class="hide-element" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <div class="col class_input_search mt-2" style="padding: 0;">
                <input id="input_search" class="form-control py-2 rounded-pill border border-gray w-100" style="margin: 0; max-width: 180px;" type="text" name="input_search" placeholder="meklēt..." />
            </div>
        </div>
    </div>
</div>
			...
			<!-- Element sections -->
				<div id="div_sections">
				<!-- Comment Editor -->
					<section id="section_comments_editor" class="main_section_selector mx-0 mx-md-5 bg--white rounded border border-gray" style="display: none; min-height: 100vh; margin: 0px; padding: 0px; ">
					
						<div style=" margin: 0px; height: 100vh; ">
							<iframe id="iframe_comments_editor" src="/editor/?id=0" style="overflow:hidden;height:100%;width:100%" height="100%" width="100%" title="Iframe Example">
							</iframe>				
						</div>
					</section>
				<!-- End Comment Editor -->
				...
				<!-- Bible Comentary Section -->
					<section id="section_comments" class="main_section_selector custom-margin bg--white rounded border border-gray" style="display: none; min-height: 100vh; ">
						<div class="Passage__PassageContainer-sc-1drf6wh-1 crkUpe text-center">
							<h1 class="Passage__StyledPassageTitle-sc-1drf6wh-0 eUlFsT book-title-font mb-2">Bībeles komentāri
							</h1>
						</div>
						
						<div class="dropdown">
  							<button class="btn px-3 dropdown-toggle mb-1 button-text-color" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false" style="border-radius: 10px;">
    							Izvēlies grāmatu
  							</button>
  							<ul id="comment_book_names" class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="overflow-y: auto; max-height: 200px;">
							</ul>
						</div>
				...
				<!-- Bibele Dictionary Section -->
					<section id="section_dictionary" class="main_section_selector custom-margin bg--white rounded border border-gray" style="display: none; min-height: 100vh; ">
						<div class="Passage__PassageContainer-sc-1drf6wh-1 crkUpe text-center">
							<h1 class="Passage__StyledPassageTitle-sc-1drf6wh-0 eUlFsT book-title-font mb-5">Bībeles vārdnīca
							</h1>
						</div>
				...
				<!-- Search Bar Section -->
					<section id="section_bible_results" class="main_section_selector custom-margin bg--white rounded border border-gray" style="display: none; min-height: 100vh; ">
						<div class="Passage__PassageContainer-sc-1drf6wh-1 crkUpe text-center">
				...
				<!-- Bible Section -->
					<section id="section_bible" class="main_section_selector custom-margin bg--white rounded border border-gray" style="min-height: 100vh;">	
						<div class="Passage__PassageContainer-sc-1drf6wh-1 crkUpe text-center">
							<h1 class="Passage__StyledPassageTitle-sc-1drf6wh-0 eUlFsT">
								<a type="button" aria-controls="sidebar_bottom" data-bs-toggle="offcanvas" data-bs-target="#sidebar_book">
							...
							<div class="offcanvas offcanvas-bottom text-center" data-bs-backdrop="false" tabindex="-999" id="sidebar_book" aria-labelledby="offcanvasBottomLabel" style="--bs-offcanvas-height: 100vh; transition: all 0.2s;">
					...
					<!-- Comment offcanvas -->
						<div class="offcanvas offcanvas-bottom" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-999" id="sidebar_bottom" aria-labelledby="offcanvasBottomLabel">
    						<div class="offcanvas-header align-items-center bg-canvastop">
        						<h2 class="offcanvas-title ms-4" id="offcanvasCommentLabel" style="margin-right: 30px;">Attiecīgā rakstvieta</h2>
        						<button type="button" class="offcanvas-modal-btn-left" onclick="showColorPicker(selectedVerseId)">Iekrāsot pantu</button>
								<button type="button" class="offcanvas-modal-btn-right" onclick="showCommentModal(selectedVerseId)">Komentēt pantu</button>
        						<button type="button" class="btn-close px-4 py-4" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    						</div>
    						<div class="offcanvas-body small bg-canvasbody" style="overscroll-behavior: contain; overflow-y: scroll;">
        						<h3 class="offcanvas-title mt-3" id="offcanvasCommentText" style="margin: 20px;">Komentārs par rakstvietu.</h3>
    						</div>
						</div>
					...
					<!-- End Comment offcanvas -->
						...
						<div id="versePill" class="verse-pill" style="display: none;">
    						...
    						<button class="pill-btn-right" onclick="showCommentModal(selectedVerseId)">Komentēt pantu</button>
						</div>
						...
						<div id="colorPickerModal" class="color-modal">
  							<div class="color-modal-content">
    							...
    							<div class="color-options">
									<button class="color-option" style="background-color: #e4dd11;" onclick="selectColor('#e4dd11')"></button>
									<button class="color-option" style="background-color: #e41111;" onclick="selectColor('#e41111')"></button>
									<button class="color-option" style="background-color: #e411d2;" onclick="selectColor('#e411d2')"></button>
									<button class="color-option" style="background-color: #19cc58;" onclick="selectColor('#19cc58')"></button>
      								<button class="color-option" style="background-color: #006eff;" onclick="selectColor('#006eff')"></button>
      								<button class="color-option" style="background-color: #11c1e4;" onclick="selectColor('#11c1e4')"></button>
    							</div>
						...
						<!-- Modal Structure -->
						<div class="modal fade" id="loginModal" tabindex="1" aria-labelledby="loginModalLabel" aria-hidden="true" data-bs-backdrop="false" style="--bs-modal-width: 350px; background: rgba(0, 0, 0, 0.5);">
    						<div class="modal-dialog" style="position: absolute; top: 50%; left: 48%; transform: translate(-50%, -50%); width: 350px">
        						<div class="modal-content">
            						<div class="modal-header">
                						<h4 class="modal-title" style="margin-bottom:0" id="loginModalLabel">Nepieciešama pierakstīšanās</h4>
            						...
            						<div class="modal-footer">
                						<button class="login-modal-btn" onclick="location.href='log-in/login.html'">Pierakstīties</button>
            						</div>
        						</div>
    						</div>
						</div>
...
jQuery(document).ready(function() {
	...
	$('.hover-underline-animation').on('click', function() {
  		$('.hover-underline-animation').not(this).removeClass('.hover-underline-animation-underline');
